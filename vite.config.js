...
export default defineConfig({
  ...
  resolve: {
    alias: {
      ...
      './lib/image-utils/index.js': resolve(__dirname, 'src/lib/image-utils/index.browser.js'),
      './chains/web-scrape/index.js': resolve(__dirname, 'src/chains/web-scrape/index.browser.js'),
