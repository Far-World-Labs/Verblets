...
describe('Dismantle verblet', () => {
  it ('2022 Aprilia Tuono 660', async () => {
...
`
    ...
    await dismantleBike.attachSubtree({ depth: 1, find: (node) => node.name === 'Fuel Injector'})
    await dismantleBike.attachSubtree({ depth: 1, find: (node) => node.name === 'Exhaust System'})
