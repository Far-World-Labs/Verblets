...
describe('document-shrink examples', () => {
  ...
  it('summarizes a technical manual to help troubleshoot a specific error', async () => {
  ...
  it('extracts recipe instructions from a food blog post full of stories', async () => {
  ...
  it('handles edge case of very aggressive reduction', async () => {
    const technicalManual = fs.readFileSync(path.join(samplesDir, 'technical-manual.txt'), 'utf8');
