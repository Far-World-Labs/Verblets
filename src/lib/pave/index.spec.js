  ...
  examples: [
    {
      ...
      inputs: { obj: {}, path: 'a.b.c', value: 42, want: { a: { b: { c: 42 } } } },
    },
    {
    ...
    },
    {
      ...
      inputs: { obj: {}, path: 'a.0.b', value: 42, want: { a: [{ b: 42 }] } },
    },
    {
      name: 'set a value on an existing object',
      inputs: { obj: { x: { y: 1 } }, path: 'x.z', value: 2, want: { x: { y: 1, z: 2 } } },
    },
    {
      name: 'set a value on an existing array',
      inputs: { obj: [0, [1]], path: '1.2', value: 3, want: [0, [1, undefined, 3]] },
    },
    {
      name: 'override an existing value in an object',
      inputs: { obj: { a: { b: 1 } }, path: 'a.b', value: 99, want: { a: { b: 99 } } },
    },
    {
      name: 'override an existing value in an array',
      inputs: { obj: [0, [1, 2]], path: '1.1', value: 99, want: [0, [1, 99]] },
    },
    {
      name: 'throws on an empty path',
      inputs: { obj: { x: 1 }, path: '', value: 42, throws: true },
    },
    {
    ...
    },
    {
      ...
      inputs: { obj: {}, path: 'a', value: 42, want: { a: 42 } },
    },
    {
      name: 'handle numeric-like string keys',
      inputs: { obj: {}, path: 'a.1b.c', value: 42, want: { a: { '1b': { c: 42 } } } },
    },
  ],
  process: ({ obj, path, value }) => pave(obj, path, value),
